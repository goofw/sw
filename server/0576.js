function(module, exports, __webpack_require__) {
    "use strict";
    var bufferEquals = __webpack_require__(112), randomBytes = __webpack_require__(113), EventEmitter = __webpack_require__(5).EventEmitter, inherits = __webpack_require__(6);
    function KBucket(options) {
        if (EventEmitter.call(this), options = options || {}, this.localNodeId = options.localNodeId || randomBytes(20), 
        !Buffer.isBuffer(this.localNodeId)) throw new TypeError("localNodeId is not a Buffer");
    ...
    module.exports = KBucket, inherits(KBucket, EventEmitter), KBucket.arbiter = function(incumbent, candidate) {
        ...
        for (var i = 0; i < node.contacts.length; ++i) if (bufferEquals(node.contacts[i].id, id)) return i;
        return -1;
