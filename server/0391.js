function(module, exports, __webpack_require__) {
    ...
    }, Stream = __webpack_require__(393), Buffer = __webpack_require__(23).Buffer, OurUint8Array = global.Uint8Array || function() {}, util = Object.create(__webpack_require__(32));
    util.inherits = __webpack_require__(6);
    var debugUtil = __webpack_require__(0), debug = void 0;
    debug = debugUtil && debugUtil.debuglog ? debugUtil.debuglog("stream") : function() {};
    var StringDecoder, BufferList = __webpack_require__(794), destroyImpl = __webpack_require__(394);
    util.inherits(Readable, Stream);
    var kProxyEvents = [ "error", "close", "destroy", "pause", "resume" ];
    function ReadableState(options, stream) {
        options = options || {};
        var isDuplex = stream instanceof (Duplex = Duplex || __webpack_require__(74));
        ...
        this.readingMore = !1, this.decoder = null, this.encoding = null, options.encoding && (StringDecoder || (StringDecoder = __webpack_require__(133).StringDecoder), 
        this.decoder = new StringDecoder(options.encoding), this.encoding = options.encoding);
    }
    function Readable(options) {
        if (Duplex = Duplex || __webpack_require__(74), !(this instanceof Readable)) return new Readable(options);
    ...
    Readable.prototype._destroy = function(err, cb) {
        ...
        return StringDecoder || (StringDecoder = __webpack_require__(133).StringDecoder), 
