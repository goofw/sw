function(module, exports, __webpack_require__) {
    ...
    }, Stream = __webpack_require__(393), Buffer = __webpack_require__(23).Buffer, OurUint8Array = global.Uint8Array || function() {}, destroyImpl = __webpack_require__(394);
    function nop() {}
    function WritableState(options, stream) {
        Duplex = Duplex || __webpack_require__(74), options = options || {};
    ...
    function Writable(options) {
        if (Duplex = Duplex || __webpack_require__(74), !(realHasInstance.call(Writable, this) || this instanceof Duplex)) return new Writable(options);
