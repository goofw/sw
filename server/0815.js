function(module, exports, __webpack_require__) {
    "use strict";
    var debug = __webpack_require__(41)("matroska:decoder"), debugTag = __webpack_require__(41)("matroska:decoder:tag"), url = (__webpack_require__(2), 
    __webpack_require__(7)), util = (__webpack_require__(10).SlowBuffer, __webpack_require__(0)), Writable = __webpack_require__(3).Writable, Document2 = __webpack_require__(817), Source = __webpack_require__(408), FileSource = __webpack_require__(409), HttpSource = __webpack_require__(410), tools = __webpack_require__(75), schema = __webpack_require__(13);
    ...
    module.exports = Decoder, util.inherits(Decoder, Writable), Decoder.OnlyMetaDatas = function() {
        ...
        if ("string" == typeof source && (/^http(s?):\/\//.test(source) ? source = new HttpSource(source) : (/^file:\/\//.test(source) && (source = url.fileURLToPath(source)), 
        source = new FileSource(source))), source instanceof Source == 0) throw new Error("Invalid source parameter (" + source + ")");
        ...
        try {
            ...
            return this._parsingError = x, this._stop = !0, void done();
        }
