function(module, exports, __webpack_require__) {
    ...
    var util = __webpack_require__(0), debug = __webpack_require__(40)("matroska:httpSource"), http = __webpack_require__(674).http, Url = __webpack_require__(7), AbstractSource = __webpack_require__(171), httpSourceKey = 0;
    ...
    util.inherits(HttpSource, AbstractSource), module.exports = HttpSource, HttpSource.prototype.getStream = function(session, params, callback) {
        ...
        var request = http.get(options, (function(response) {
            if (debug("Response=", response.statusCode, response.statusMessage), 2 !== Math.floor(response.statusCode / 100)) return callback(new Error("Invalid status '" + response.statusCode + "' message='" + response.statusMessage + "' for url=" + url));
            if (params.start) {
