function(module, exports, __webpack_require__) {
    "use strict";
    var async = __webpack_require__(38), util = __webpack_require__(0), Document1 = __webpack_require__(818);
    function Document2() {
        Document1.call(this);
    }
    __webpack_require__(13), util.inherits(Document2, Document1), module.exports = Document2, 
    Document2.prototype.optimizeData = function(options, callback) {
        return 1 === arguments.length && "function" == typeof options && (callback = options, 
        options = null), this.children ? (options = options || {}, this.deepWalk((function(child) {
            child._optimizeData(options);
        })), callback()) : callback();
