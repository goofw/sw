    ...
    (function(module) {
        ...
        !(function() {
            ...
            _.find = _.detect = function(obj, predicate, context) {
                ...
                if (null == iteratee || "number" == typeof iteratee && "object" != typeof obj[0] && null != obj) for (var i = 0, length = (obj = isArrayLike(obj) ? obj : _.values(obj)).length; i < length; i++) null != (value = obj[i]) && value > result && (result = value); else iteratee = cb(iteratee, context), 
            ...
            var eq, deepEq, keyInObj = function(value, key, obj) {
                return key in obj;
            };
            ...
            "object" != typeof Int8Array && "function" != typeof nodelist && (_.isFunction = function(obj) {
