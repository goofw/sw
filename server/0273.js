function(module, exports, __webpack_require__) {
    "use strict";
    var assert = __webpack_require__(24), async = __webpack_require__(38), crc32 = __webpack_require__(71).crc32, stream = __webpack_require__(3), util = __webpack_require__(0), fs = __webpack_require__(2), debug = __webpack_require__(40)("matroska:element"), schema = __webpack_require__(12), tools = __webpack_require__(72), MillenniumTime = Date.UTC(2001, 0, 1);
    function Element(doc, tagId, ebmlID, start, length) {
        ...
        schemaInfo || (console.error("Unknown schemaID ", ebmlID && "0x" + ebmlID.toString(16), "tagId=", tagId, "start=" + start + " length=" + length + " source=", doc.source), 
        schemaInfo = {
            type: "unknown",
    ...
    module.exports = Element, Element.prototype._setDataSize = function(dataSize, lengthTagSize) {
        ...
        if (!this.masterType) throw console.error(this), new Error("Element " + this._name + "/" + this.ebmlID + "/" + this.type + " is not a master type");
